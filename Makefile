...
BUILD       	:=  build
LIBBUTANO   	:=  /Users/cck/repos/butano/butano
PYTHON      	:=  python3
...
#---------------------------------------------------------------------------------------------------------------------
# Export absolute butano parent path:
#---------------------------------------------------------------------------------------------------------------------
ifndef LIBBUTANOPARENT
	export LIBBUTANOPARENT	:=	/Users/cck/repos/butano
endif
